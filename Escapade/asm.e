--Nonstandard eddition , Daniel Kluss(xerox_irs@lvcm.com) has added a few things
-- asm.e
...
--
-- Intruder alert!
-- Removed upper() and included wildcard.e instead to make it work 
-- with Win32lib.
-- /Mic, 000522
--
...
-- /Mic, 000705
--
-- Added f(u)comi(p) and conditional f.p. moves.
-- /Mic, 000709
--
-- Added punpckhwd and fixed a typo (punpcklbw was included twice, and punpcklwd not at all)
-- /Mic, 030521
--
-- Added 70+ SSE instructions, and some missing MMX instrucions (PMAX, PAVG i.a.)
-- /Mic, 030522


global constant asm_version = "May 22, 2003"
...
constant
    ...
    OWORD = BYTE + DWORD  -- 16 bytes (SSE only)
...
constant
    ...
    SSE_REG = REGISTER, --power(2,30),
    --SSE_MODRM = power(2,30),
    SSE_MODRM_REG = EXTENSION + OWORD,
...
constant keywords = {
    ...
    {"QWORD PTR",   MODRM + QWORD}, --/Mic, 030522
    {"OWORD PTR",   MODRM + OWORD}, --/Mic, 030522
    {"BYTE",    LABEL + BYTE},
    {"WORD",    LABEL + WORD},
    {"DWORD",   LABEL + DWORD},
    ...
    {"CPUID",   {#0F,#A2}},
    {"RDTSC",   {#0F,#31}}, -- http://developer.intel.com/drg/pentiumII/appnotes/RDTSCPM1.HTM
...
-- MMX 
    ...
    {"MOVD",    {#0F,#6E, EXTENSION + DWORD},
                ...
                --{#66,#0F,#6E, EXTENSION + DWORD},
                --{#66,#0F,#7E, REVERSE + EXTENSION + DWORD}},                  
    {"MOVQ",    {#0F,#6F, MMX_MODRM_REG},
                {#0F,#7F, REVERSE + MMX_MODRM_REG},
                {#F3,#0F,#7E, SSE_REG + EXTENSION + QWORD},
                {#66,#0F,#D6, REVERSE + SSE_MODRM_REG}},
    {"MOVNTQ",  {#0F,#E7, REVERSE + MMX_MODRM_REG}},
    {"MASKMOVQ", {#0F,#F7,MMX_MODRM_REG}},
                
    {"PACKSSDW",{#0F,#6B, MMX_MODRM_REG},
                {#66,#0F,#6B, SSE_MODRM_REG}}, --/Mic, 030522
    {"PACKSSWB",{#0F,#63, MMX_MODRM_REG},
                {#66,#0F,#63, SSE_MODRM_REG}}, --/Mic, 030522
    {"PACKUSWB",{#0F,#67, MMX_MODRM_REG},
                {#66,#0F,#67, SSE_MODRM_REG}},
    {"PADDB",   {#0F,#FC, MMX_MODRM_REG},
                {#66,#0F,#FC, SSE_MODRM_REG}},
    {"PADDD",   {#0F,#FE, MMX_MODRM_REG},
                {#66,#0F,#FE, SSE_MODRM_REG}},
    {"PADDQ",   {#0F,#D4, MMX_MODRM_REG},      --/Mic, 030522
                {#66,#0F,#D4, SSE_MODRM_REG}},
    {"PADDSB",  {#0F,#EC, MMX_MODRM_REG},
                {#66,#0F,#EC, SSE_MODRM_REG}},
    {"PADDSW",  {#0F,#ED, MMX_MODRM_REG},
                {#66,#0F,#ED, SSE_MODRM_REG}},
    {"PADDUSB", {#0F,#DC, MMX_MODRM_REG},
                {#66,#0F,#DC, SSE_MODRM_REG}},
    {"PADDUSW", {#0F,#DD, MMX_MODRM_REG},
                {#66,#0F,#DD, SSE_MODRM_REG}},
    {"PADDW",   {#0F,#FD, MMX_MODRM_REG},
                {#66,#0F,#FD, SSE_MODRM_REG}},
    {"PAND",    {#0F,#DB, MMX_MODRM_REG},
                {#66,#0F,#DB, SSE_MODRM_REG}},
    {"PANDN",   {#0F,#DF, MMX_MODRM_REG},
                {#66,#0F,#DF, SSE_MODRM_REG}},
    {"PAVGB",   {#0F,#E0, MMX_MODRM_REG},       --/Mic, 030522
                {#66,#0F,#E0, SSE_MODRM_REG}},
    {"PAVGW",   {#0F,#E3, MMX_MODRM_REG},
                {#66,#0F,#E3, SSE_MODRM_REG}},
    {"PCMPEQB", {#0F,#74, MMX_MODRM_REG},
                {#66,#0F,#74, SSE_MODRM_REG}},
    {"PCMPEQD", {#0F,#76, MMX_MODRM_REG},
                {#66,#0F,#76, SSE_MODRM_REG}},
    {"PCMPEQW", {#0F,#75, MMX_MODRM_REG},
                {#66,#0F,#75, SSE_MODRM_REG}},
    {"PCMPGTB", {#0F,#64, MMX_MODRM_REG},
                {#66,#0F,#64, SSE_MODRM_REG}},
    {"PCMPGTD", {#0F,#66, MMX_MODRM_REG},
                {#66,#0F,#66, SSE_MODRM_REG}},
    {"PCMPGTW", {#0F,#65, MMX_MODRM_REG},
                {#66,#0F,#65, SSE_MODRM_REG}},
    {"PMADDWD", {#0F,#F5, MMX_MODRM_REG},
                {#66,#0F,#F5, SSE_MODRM_REG}},
    {"PMAXSW",  {#0F,#EE, MMX_MODRM_REG},       --/Mic, 030522
                {#66,#0F,#EE, SSE_MODRM_REG}},
    {"PMAXUB",  {#0F,#DE, MMX_MODRM_REG},
                {#66,#0F,#DE, SSE_MODRM_REG}},
    {"PMINSW",  {#0F,#EA, MMX_MODRM_REG},
                {#66,#0F,#EA, SSE_MODRM_REG}},
    {"PMINUB",  {#0F,#DA, MMX_MODRM_REG},
                {#66,#0F,#DA, SSE_MODRM_REG}},
    --{"PMOVMSKB",{#0F,#D7, REVERSE+REGISTER+EXTENSION+QWORD},
    --          {#66,#0F,#D7,REGISTER+EXTENSION+OWORD}},
    ...
    {"PSLLD",   {#0F,#F2, MMX_MODRM_REG},
                ...
                {#66,#0F,#F2, SSE_MODRM_REG},
                {#66,#0F,#72, #F0 + SSE_REG + IMMED + BYTE}},
    ...
    {"PUNPCKHWD",{#0F,#69, MMX_MODRM_REG}},
    {"PUNPCKHDQ",{#0F,#6A, MMX_MODRM_REG}},
    {"PUNPCKLBW",{#0F,#60, MMX_MODRM_REG}},
    {"PUNPCKLWD",{#0F,#61, MMX_MODRM_REG}},
    {"PUNPCKLDQ",{#0F,#62, MMX_MODRM_REG}},
    {"PXOR",    {#0F,#EF, MMX_MODRM_REG}},

-- SSE
    {"XMMREG0",   SSE_REG + OWORD + 0}, {"XMM0",   SSE_REG + OWORD + 0},
    {"XMMREG1",   SSE_REG + OWORD + 1}, {"XMM1",   SSE_REG + OWORD + 1},
    {"XMMREG2",   SSE_REG + OWORD + 2}, {"XMM2",   SSE_REG + OWORD + 2},
    {"XMMREG3",   SSE_REG + OWORD + 3}, {"XMM3",   SSE_REG + OWORD + 3},
    {"XMMREG4",   SSE_REG + OWORD + 4}, {"XMM4",   SSE_REG + OWORD + 4},
    {"XMMREG5",   SSE_REG + OWORD + 5}, {"XMM5",   SSE_REG + OWORD + 5},
    {"XMMREG6",   SSE_REG + OWORD + 6}, {"XMM6",   SSE_REG + OWORD + 6},
    {"XMMREG7",   SSE_REG + OWORD + 7}, {"XMM7",   SSE_REG + OWORD + 7},

    {"ADDPD",   {#66,#0F,#58,SSE_MODRM_REG}},   
    {"ADDPS",   {#0F,#58,SSE_MODRM_REG}},
    {"ADDSD",   {#F2,#0F,#58,SSE_MODRM_REG}},
    {"ADDSS",   {#F3,#0F,#58,SSE_MODRM_REG}},
    {"ANDPD",   {#66,#0F,#54,SSE_MODRM_REG}},
    {"ANDPS",   {#0F,#54,SSE_MODRM_REG}},
    {"ANDNPD",  {#66,#0F,#55,SSE_MODRM_REG}},
    {"ANDNPS",  {#0F,#55,SSE_MODRM_REG}},
    {"CMPPD",   {#66,#0F,#C2-1,SSE_REG+MODRM+IMMED+BYTE+REVERSE}},
    {"CMPPS",   {#0F,#C2-1,SSE_REG+MODRM+IMMED+BYTE+REVERSE}},
    {"CMPSD",   {#F2,#0F,#C2-1,SSE_REG+MODRM+IMMED+BYTE+REVERSE}},
    {"CMPSS",   {#F3,#0F,#C2-1,SSE_REG+MODRM+IMMED+BYTE+REVERSE}},
    {"COMISD",  {#66,#0F,#2F,SSE_MODRM_REG}},
    {"COMISS",  {#0F,#2F,SSE_MODRM_REG}},
    {"CVTDQ2PD",{#F3,#0F,#E6,SSE_MODRM_REG}},
    {"CVTDQ2PS",{#0F,#5B,SSE_MODRM_REG}},
    {"CVTPD2DQ",{#F2,#0F,#E6,SSE_MODRM_REG}},
    {"CVTPD2PS",{#66,#0F,#5A,SSE_MODRM_REG}},
    {"CVTPS2DQ",{#66,#0F,#5B,SSE_MODRM_REG}},
    {"CVTPS2PD",{#0F,#5A,SSE_MODRM_REG}},
    {"CVTSD2SI",{#F2,#0F,#2D-1,REGISTER+MODRM+REVERSE}},
    {"CVTSD2SS",{#F2,#0F,#5A,SSE_MODRM_REG}},
    {"CVTSI2SD",{#F2,#0F,#2A,SSE_MODRM_REG}},
    {"CVTSI2SS",{#F3,#0F,#2A,SSE_MODRM_REG}},
    {"CVTSS2SD",{#F3,#0F,#5A,SSE_MODRM_REG}},
    {"CVTSS2SI",{#F3,#0F,#2D-1,REGISTER+MODRM+REVERSE}},
    {"CVTTPD2DQ",{#66,#0F,#E6,SSE_MODRM_REG}},
    {"CVTTPS2DQ",{#F3,#0F,#5B,SSE_MODRM_REG}},
    {"DIVPD",   {#66,#0F,#5E,SSE_MODRM_REG}},
    {"DIVPS",   {#0F,#5E,SSE_MODRM_REG}},
    {"DIVSD",   {#F2,#0F,#5E,SSE_MODRM_REG}},
    {"DIVSS",   {#F3,#0F,#5E,SSE_MODRM_REG}},
    {"MAXPD",   {#66,#0F,#5F,SSE_MODRM_REG}},
    {"MAXPS",   {#0F,#5F,SSE_MODRM_REG}},
    {"MAXSD",   {#F2,#0F,#5F,SSE_MODRM_REG}},
    {"MAXSS",   {#F3,#0F,#5F,SSE_MODRM_REG}},
    {"MINPD",   {#66,#0F,#5D,SSE_MODRM_REG}},
    {"MINPS",   {#0F,#5D,SSE_MODRM_REG}},
    {"MINSD",   {#F2,#0F,#5D,SSE_MODRM_REG}},
    {"MINSS",   {#F3,#0F,#5D,SSE_MODRM_REG}},
    {"MOVAPD",  {#66,#0F,#28,SSE_MODRM_REG},            
                {#66,#0F,#29,SSE_MODRM_REG+REVERSE}},
    {"MOVAPS",  {#0F,#28,SSE_MODRM_REG},                
                {#0F,#29,SSE_MODRM_REG+REVERSE}},
    {"MOVDQA",  {#66,#0F,#6F,SSE_MODRM_REG},
                {#66,#0F,#7F,SSE_MODRM_REG+REVERSE}},
    {"MOVDQU",  {#F3,#0F,#6F,SSE_MODRM_REG},
                {#F3,#0F,#7F,SSE_MODRM_REG+REVERSE}},
    {"MOVLPS",  {#0F,#12,SSE_MODRM_REG},
                {#0F,#13,SSE_MODRM_REG+REVERSE}},
    --{"MOVQ2DQ",       {#F3,#0F,#D6,MMX_REG}},
    {"MOVSS",   {#F3,#0F,#10,SSE_MODRM_REG},
                {#F3,#0F,#11,REVERSE+SSE_MODRM_REG}},
    {"MULPD",   {#66,#0F,#59,SSE_MODRM_REG}},
    {"MULPS",   {#0F,#59,SSE_MODRM_REG}},
    {"MULSD",   {#F2,#0F,#59,SSE_MODRM_REG}},
    {"MULSS",   {#F3,#0F,#59,SSE_MODRM_REG}},
    {"ORPD",    {#66,#0F,#56,SSE_MODRM_REG}},
    {"ORPS",    {#0F,#56,SSE_MODRM_REG}},
    {"PSHUFD",  {#66,#0F,#70-1,SSE_REG+MODRM+IMMED+BYTE+REVERSE}},
    {"RCPPS",   {#0F,#53, SSE_MODRM_REG}},
    {"RCPSS",   {#F3,#0F,#53, SSE_MODRM_REG}},
    {"RSQRTPS", {#0F,#52, SSE_MODRM_REG}},
    {"RSQRTSS", {#F3,#0F,#52, SSE_MODRM_REG}},
    {"SHUFPD",  {#66,#0F,#C6-1,SSE_REG+MODRM+IMMED+BYTE+REVERSE}},
    {"SHUFPS",  {#0F,#C6-1,SSE_REG+MODRM+IMMED+BYTE+REVERSE}},
    {"SQRTPD",  {#66,#0F,#51, SSE_MODRM_REG}},
    {"SQRTPS",  {#0F,#51, SSE_MODRM_REG}},
    {"SQRTSD",  {#F2,#0F,#51, SSE_MODRM_REG}},
    {"SQRTSS",  {#F3,#0F,#51, SSE_MODRM_REG}},
    {"SUBPD",   {#66,#0F,#5C, SSE_MODRM_REG}},
    {"SUBPS",   {#0F,#5C, SSE_MODRM_REG}},
    {"SUBSD",   {#F2,#0F,#5C, SSE_MODRM_REG}},
    {"SUBSS",   {#F3,#0F,#5C, SSE_MODRM_REG}},
    {"UCOMISD", {#66,#0F,#2E,SSE_MODRM_REG}},
    {"UCOMISS", {#0F,#2E,SSE_MODRM_REG}},    
    {"UNPCKHPD",{#66,#0F,#15, SSE_MODRM_REG}},
    {"UNPCKHPS",{#0F,#15, SSE_MODRM_REG}},
    {"UNPCKLPD",{#66,#0F,#14, SSE_MODRM_REG}},
    {"UNPCKLPS",{#0F,#14, SSE_MODRM_REG}},
    {"XORPD",   {#66,#0F,#57,SSE_MODRM_REG}},
    {"XORPS",   {#0F,#57,SSE_MODRM_REG}},    
...
-- 3DNow!
    ...
    {"PREFETCHNTA",{#0F,#18, #00 + MODRM}},
    {"PREFETCHT0",{#0F,#18, #08 + MODRM}},
    {"PREFETCHT1",{#0F,#18, #10 + MODRM}},
    {"PREFETCHT2",{#0F,#18, #18 + MODRM}},

-- Conditional MOVes
    {"CMOVO",{#0F,#40-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNO",{#0F,#41-1, MODRM + REGISTER + REVERSE}},
    {"CMOVB",{#0F,#42-1, MODRM + REGISTER + REVERSE}},
    {"CMOVC",{#0F,#42-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNAE",{#0F,#42-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNB",{#0F,#43-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNC",{#0F,#43-1, MODRM + REGISTER + REVERSE}},
    {"CMOVAE",{#0F,#43-1, MODRM + REGISTER + REVERSE}},
    {"CMOVE",{#0F,#44-1, MODRM + REGISTER + REVERSE}},
    {"CMOVZ",{#0F,#44-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNE",{#0F,#45-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNZ",{#0F,#45-1, MODRM + REGISTER + REVERSE}},
    {"CMOVBE",{#0F,#46-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNA",{#0F,#46-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNBE",{#0F,#47-1, MODRM + REGISTER + REVERSE}},
    {"CMOVA",{#0F,#47-1, MODRM + REGISTER + REVERSE}},
    {"CMOVS",{#0F,#48-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNS",{#0F,#49-1, MODRM + REGISTER + REVERSE}},
    {"CMOVP",{#0F,#4A-1, MODRM + REGISTER + REVERSE}},
    {"CMOVPE",{#0F,#4A-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNP",{#0F,#4B-1, MODRM + REGISTER + REVERSE}},
    {"CMOVPO",{#0F,#4B-1, MODRM + REGISTER + REVERSE}},
    {"CMOVL",{#0F,#4C-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNGE",{#0F,#4C-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNL",{#0F,#4D-1, MODRM + REGISTER + REVERSE}},
    {"CMOVGE",{#0F,#4D-1, MODRM + REGISTER + REVERSE}},
    {"CMOVLE",{#0F,#4E-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNG",{#0F,#4E-1, MODRM + REGISTER + REVERSE}},
    {"CMOVNLE",{#0F,#4F,MODRM + REGISTER + REVERSE}},
    {"CMOVG",{#0F,#4F-1,MODRM + REVERSE + REGISTER}},

-- FP compare instructions setting integer flags
    {"FCOMI",{#DB,#F0+FPU_STACK}},
    {"FCOMIP",{#DF,#F0+FPU_STACK}},
    {"FUCOMI",{#DB,#E8+FPU_STACK}},
    {"FUCOMIP",{#DF,#E8+FPU_STACK}},

-- Conditional FP MOVes
    {"FCMOVB",{#DA,#C0+FPU_STACK}},
    {"FCMOVC",{#DA,#C0+FPU_STACK}},
    {"FCMOVNB",{#DB,#C0+FPU_STACK}},
    {"FCMOVNC",{#DB,#C0+FPU_STACK}},
    {"FCMOVAE",{#DB,#C0+FPU_STACK}},
    {"FCMOVE",{#DA,#C8+FPU_STACK}},
    {"FCMOVZ",{#DA,#C8+FPU_STACK}},
    {"FCMOVNE",{#DB,#C8+FPU_STACK}},
    {"FCMOVNZ",{#DB,#C8+FPU_STACK}},
    {"FCMOVBE",{#DA,#D0+FPU_STACK}},
    {"FCMOVNA",{#DA,#D0+FPU_STACK}},
    {"FCMOVNBE",{#DB,#D0+FPU_STACK}},
    {"FCMOVA",{#DB,#D0+FPU_STACK}},
    {"FCMOVU",{#DA,#D8+FPU_STACK}},
    {"FCMOVNU",{#DB,#D8+FPU_STACK}}
    ...
    while 1 do
        ...
        if compare(and_bits(kw, LABEL), LABEL) = 0 then
            ...
            if compare(and_bits(kw, DATA), DATA) = 0 then
                ...
                elsif this_item[2] = OWORD then this_item[2] = #1000  -- /Mic, 030522
                end if
    ...
    for i = 1 to length(code) do
        ...
        if and_bits(attr[i], EXTENSION) then
            ...
            if and_bits(param[1], REGISTER) and and_bits(param[2], MODRM) then
                ...
                elsif attr_size_mask = OWORD or attr_size_mask = QWORD or attr_size_mask = DWORD then
                    if and_bits(param[2], SIZE_MASK) = 0 then
                        param[2] = param[2] + attr_size_mask
                    end if 

                    if (and_bits(param[1], SIZE_MASK) != QWORD and
                        and_bits(param[1], SIZE_MASK) != OWORD) --/Mic, 030522
...
--     (use 1 for asm_output_file for output to the screen)
    ...
    while asm_pos <= length(asm_text) do
        ...
        if compare(and_bits(token, DATA), DATA) = 0 then
            ...
            elsif token = OWORD then token = #1000 end if --/Mic, 030522
            code = get_data(token)
            no_whitespace()
        else
